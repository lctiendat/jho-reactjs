  ...
  return (
    <div className="flex items-center gap-4">
      <div className="relative flex-1 max-w-[407px] max-h-[40px] ">
        ...
        />
        <select className="w-full pl-8 pr-3 py-2 bg-transparent text-[12px] placeholder-red-500 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#f85149]" name="" id="">
